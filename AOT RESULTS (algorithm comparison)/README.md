...
|-------------------------|------------------|--------------------|----------------------|-------------------------------|
| Softmax                 | 0.080   (0.542)  | 0.080   (0.542)    | 0.875    (0.542)     | 0.842    ( err )              |
| Logsumexp (density)     | 0.069   (0.541)  | 0.071   (0.542)    | 0.870    (0.529)     | 0.855    ( err )              |
| Entropy (Energy)        | 0.310   (0.542)  | 0.310   ( err )    | 0.927    (0.522)     | 0.939    ( err )              |


### GMM per Layer (mAP in parenthesis)
| Layer                 | Logsumexp AUROC   | Entropy AUROC  | Logsumexp AUROC (Pruned <20)  | Entropy AUROC (Pruned <20)  |
|-----------------------|-------------------|----------------|-------------------------------|-----------------------------|
| Layer 1               | 0.466   (0.336)   | 0.591* ( err ) | 0.913                         | 0.575*                      |
| Layer 2               | 0.499   (0.152)   | 0.572* ( err ) | 0.917                         | 0.593*                      |
...
| Layer 2 (Temp-Scaled) | 0.495             | 0.604  (0.542) | 0.915                         | 0.927                       |
| Layer 3 (Temp-Scaled) | 0.442             | 0.472          | 0.906                         | 0.931  (0.544)              |
| Layer 4 (Temp-Scaled) | 0.438             | 0.797  (0.542) | 0.925                         | 0.932  (0.542)              |
| Layer 5 (Temp-Scaled) | 0.261             | 0.679          | 0.910                         | 0.940  (0.542)              |
| Layer 6 (Temp-Scaled) | 0.104             | 0.895  (0.542) | 0.872                         | 0.894                       |
...
| Method                  | AUROC           | Temp-Scaled AUROC | AUROC (Pruned <20) | Temp-Scaled AUROC (Pruned <20) |
|-------------------------|------------------|--------------------|----------------------|-------------------------------|
| Softmax                 | 0.126  (0.520)   | 0.126  (0.520)     | 0.871  (0.520)       | 0.916  (0.515)                |
| Logsumexp (density)     | 0.120  (0.519)   | 0.127  (0.520)     | 0.814  (0.492)       | 0.870  (0.610)                |
| Entropy (Energy)        | 0.418  (0.520)   | 0.418  ( err )     | 0.910  (0.520)       | 0.939  ( err )                |
...
| Layer 1 (Temp-Scaled) | 0.409             | 0.643          | 0.811                         | 0.954   (0.520)             |
